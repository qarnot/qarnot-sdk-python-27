...
class SecretsAccessRights(object):
    ...
    def __init__(self, by_secret=None, by_prefix=None):
    ...
    def add_secret_by_key(self, key):
    ...
    def add_secrets_by_keys(self, keys):
    ...
    def add_secret_by_prefix(self, prefix):
    ...
    def add_secrets_by_prefixes(self, prefixes):
...
class Secrets(object):
    ...
    def _create_secret_raw(self, key, value):
    ...
    def list_secrets(self, prefix, recursive=False):
    ...
    def _list_secrets_once(self, prefix):
        prefix = prefix.strip('/')
