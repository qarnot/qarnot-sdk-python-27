...
class RetrySettings(object):
    ...
    _maxTotalRetries = None
    _maxPerInstanceRetries = None

    def __init__(self, maxTotalRetries=None, maxPerInstanceRetries=None):
    ...
    def from_json(cls, json):
        ...
        """
        maxTotalRetries = json.get("maxTotalRetries")
        maxPerInstanceRetries = json.get("maxPerInstanceRetries")
