...
class UserSchedulingQuota(object):
    ...
    def __init__(self, max_cores, running_cores_count, max_instances, running_instances_count):
...
class UserReservedSchedulingQuota(UserSchedulingQuota):
    ...
    def __init__(self, reservation_name, machine_key, max_cores, running_cores_count, max_instances, running_instances_count):
        ...
        """
        super(UserReservedSchedulingQuota, self).__init__(max_cores, running_cores_count, max_instances, running_instances_count)
...
class UserComputingQuotas(object):
    ...
    def __init__(self, flex, on_demand, reserved):
...
class OrganizationReservedSchedulingQuota(OrganizationSchedulingQuota):
    ...
    def __init__(self, reservation_name, machine_key, max_cores, running_cores_count, max_instances, running_instances_count):
        ...
        """
        super(OrganizationReservedSchedulingQuota, self).__init__(max_cores, running_cores_count, max_instances, running_instances_count)
        self.machine_key = machine_key
        """:type: :class:`str`
...
class OrganizationComputingQuotas(object):
    ...
    def __init__(self, name, flex, on_demand, reserved):
...
class ComputingQuotas(object):
    ...
    def __init__(self, user_computing_quotas, organization_computing_quotas=None):
