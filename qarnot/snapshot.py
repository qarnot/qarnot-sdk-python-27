...
class PeriodicSnapshotConfiguration(SnapshotConfiguration):
    ...
    def __init__(self,
        ...
        :returns: The created :class:`~qarnot.snapshot.SnapshotConfiguration`.
        """
        super(PeriodicSnapshotConfiguration, self).__init__(whitelist, blacklist, bucket_name, bucket_prefix)
    ...
    def to_json(self):
        ...
        :rtype: Dict[str, Optional[str|int]]
        """
        json = super(PeriodicSnapshotConfiguration, self).to_json()
...
class Snapshot(object):
    ...
    _status = None
    _size_to_upload = None
    _transferred_size = None
