...
class CarbonFacts(object):
    ...
    def __init__(
            ...
            carbon_footprint=0,
            equivalent_dc_name="",
            equivalent_dc_carbon_footprint=0,
            saved_carbon_footprint_compute=0,
            saved_carbon_footprint_heat=0,
            saved_carbon_footprint_compute_heat=0,
            saved_carbon_footprint_percent=0,
            PUE=0,
            ERE=0,
            ERF=0,
            WUE=0):
        ...
        :type WUE: `float`
        """
        self.energy_consumption_Wh = energy_consumption
        self.energy_it_Wh = energy_it
        self.energy_reuse_Wh = energy_reuse
        self.carbon_footprint_gC02eq = carbon_footprint
        self.equivalent_datacenter_name = equivalent_dc_name
        self.equivalent_dc_carbon_footprint_gC02eq = equivalent_dc_carbon_footprint
        self.saved_carbon_footprint_compute_gC02eq = saved_carbon_footprint_compute
        self.saved_carbon_footprint_heat_gC02eq = saved_carbon_footprint_heat
        self.saved_carbon_footprint_compute_heat_gC02eq = saved_carbon_footprint_compute_heat
        self.saved_carbon_footprint_percent = saved_carbon_footprint_percent
        self.PUE = PUE
        self.ERE = ERE
        self.ERF = ERF
        self.WUE = WUE
...
class CarbonClient(object):
    ...
    def __init__(self, connection, datacenter_name=None):
    ...
    def _get_carbon_facts_url(self, resource_type, uuid):
    ...
    def _get_pool_carbon_facts_raw(self, pool_id):
    ...
    def get_pool_carbon_facts(self, pool_id):
    ...
    def _get_task_carbon_facts_raw(self, task_id):
    ...
    def get_task_carbon_facts(self, task_id):
